...
def test_chat_create_view():
    ...
    data = {"unique_identifier": "123", "name": "Test Chat", "content": "This is a test chat."}
    ...
    assert response.status_code == 201  # Assuming the view returns a 201 status code for a successful creation
...
def test_code_fragment_create_view():
    ...
    data = {"chat_id": chat.id, "filename": "test.py", "programming_language": "python", "source_code": 'print("Hello, world!")'}
    response = client.post(url, data, format="json")
